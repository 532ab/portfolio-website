...
const Projects = () => 
{
    ...
    useEffect(() => {
        ...
        const horizonatlScroll = gsap.to("panel", {
        ...
        panels.forEach((panel, i) => {
            ...
            const imageTitle = panel.querySelector(".projec-title")

            const tl = gsap.timeline({
                scrollTrigger: {
                    trigger: panel,
                    containerAnimation: horizonatlScroll,
                    start: "left right",
                    end: "right left",
                    scrub: true,
                }
        ...
        if(imageTitle) {
            tl.fromTo(imageTitle, { y: 30}, {y: -100, duration: 0.2}, 0.2)
        }
  ...
  return (
    ...
    <div ref = {triggerRef} className = "overflow-hidden">
        <div ref = {horizontalRef} className = "horizontal-section flex md:w-[400%] w-[420%]">
            {images.map((project) => (
                <div 
                Loading key = {project.id} className='panel relative flex items-center justify-center'>
