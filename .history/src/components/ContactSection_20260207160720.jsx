...
const ContactSection = ({isOpen, onClose}) => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault()
    // Here you can add form submission logic (API call, email service, etc.)
      ...
      >
        ...
        >
          ...
          <form 
            ...
            className="mt-8 w-full max-w-md space-y-4 absolute md:scale-[0.2] sm:scale-[0.15] scale-[0.1] sm:mt-16 mt-10"
          >
            <div>
              ...
              <input
                ...
                required
                className="w-full px-4 py-2 bg-white border-2 border-black rounded-lg focus:outline-none focus:border-purple-600 transition-colors"
            ...
            <div>
              ...
              <textarea
                ...
                required
                rows="5"
                className="w-full px-4 py-2 bg-white border-2 border-black rounded-lg focus:outline-none focus:border-purple-600 transition-colors resize-none"
            ...
            <button
              type="submit"
              className="w-full px-6 py-2 rounded-lg bg-black text-white font-semibold hover:bg-purple-600 transition-all duration-300"
            >
