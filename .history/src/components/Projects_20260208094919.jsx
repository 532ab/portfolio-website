...
const Projects = () => {
  ...
  useEffect(() => {
    ...
    panels.forEach((panel) => {
      ...
      tl.fromTo(
        image,
        { scale: 0.90, rotate: -10, opacity: 0 },
  ...
  return (
    <section
      ...
      ref={sectionRef}
      id="projects"
      className="relative py-20 overflow-hidden from-gray-300 to-red-400" 
    >
      <div className="container mx-auto px-4 mb-16 relative z-10">
        <h2
          ref={titleRef}
          className="text-4xl md:text-5xl lg:text-6xl font-bold text-purple-200 text-center mb-4"
        >
          My Projects
        </h2>
        <div
            ...
            >
              <div className="relative w-full h-full flex flex-col items-center justify-center p-4 sm:p-8 md:p-12">
                ...
                <a 
                  ...
                  className="project-title flex items-center gap-3 md:text-3xl text-sm md:font-bold text-black z-50 text-nowrap hover:text-gray-400 transition-colors duration-300 cursor-pointer"
                >
                  {project.title}
                </a>
              </div>
