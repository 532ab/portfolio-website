      ...
      {isOpen && (
        <>
          ...
          <motion.form
            ...
            className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-11/12 sm:w-full max-w-md bg-gray-800 p-6 sm:p-8 rounded-2xl shadow-2xl border border-gray-700 z-50 max-h-[85vh] overflow-y-auto"
          >
            <motion.div 
