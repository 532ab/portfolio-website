  ...
  return (
    ...
    >
      <div className="container mx-auto px-4 h-full flex flex-col items-center justify-center">
        <h1
          ref={titleRef}
          className="mt-12 sm:mt-20 text-3xl sm:text-4xl md:text-6xl font-bold mb-8 sm:mb-16 text-center text-white opacity-0 px-4"
        >
          About Me
        </h1>
      </div>
      ...
      <div
        ref={introRef}
        className="absolute top-1/2 md:bottom-[-10rem] bottom-[-20rem] left-0 w-full flex md:flex-row flex-col justify-between md:px-24 px-4 sm:px-5 items-center opacity-0"
      >
        <h3 className="text-sm sm:text-base md:text-lg font-bold text-purple-200 z-50 lg:max-w-[45rem] max-w-[27rem] tracking-wider mt-60 md:mt-20 leading-relaxed">
          <TypeAnimation
            key={animationKey}
            sequence={[
