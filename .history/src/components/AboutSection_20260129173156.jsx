  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto px-4 h-full flex flex-col items-center justify-center">
        <h1
          ref={titleRef}
          className="mt-10 text-4xl md:text-6xl font-bold mb-16 text-center text-white opacity-0"
        >
          About Me
        </h1>
      </div>
      ...
      <div
        ref={introRef}
        className="absolute top-1/2 md:bottom-[-10rem] bottom-[-20rem] left-0 w-full flex md:flex-row flex-col justify-between lg:px-24 px-5 items-center opacity-0"
      >
        <h3 className="text-sm md:text-2xl font-bold text-purple-200 z-50 lg:max-w-[45rem] max-w-[27rem] tracking-wider md:mt-20 mt-[-32rem]">
