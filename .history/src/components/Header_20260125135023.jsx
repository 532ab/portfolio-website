...
const Header = () => {
        ...
        animate = {{ opacity: isOpen ? 1 : 0,
            ...
            <div className = "pt-4 border-t border-gray-200 dakr:border-gray-700">
                <div className = "flex space-x-5">
                    ...
                    onClick = {() => {
                        toggleMenu()
                     }} className = "mt--1 block w-full px-4 py-2 rounded-lg bg-gradient-to-r from-violet-600 to-violet-400 font-bold">
                        Contact Me
                    </button>
                    </div>
  ...
  >
    ...
    transition = {{
        type: "spring", damping: 30, stiffness: 200, duration: 0.8
    }}
