...
const HeroSection = () => {
  return (
    <section className=" h-screen bg-gradient-to-b from-gray-700 to-red-500 flex xl:flex-row flex-col-reverse items-center justify-between lg:px-24 px-10 relative overflow-hidden">
  ...
  {/* Right Section */}
  <div className="hidden 2xl:flex 2xl:w-1/2 justify-center">
    <Spline 
