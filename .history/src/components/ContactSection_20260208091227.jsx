      ...
      >
        ...
        >
          ...
          <form 
            ...
            className="w-full max-w-md space-y-5 bg-gray-800 p-8 rounded-xl shadow-2xl border border-gray-700 mt-8"
          >
            ...
            <button
              type="submit"
              className="w-full px-4 py-3 rounded-lg bg-violet-600 hover:bg-violet-500 text-white font-semibold transition-all duration-300 mt-6"
            >
              Send Message
            </button>
          </form>
