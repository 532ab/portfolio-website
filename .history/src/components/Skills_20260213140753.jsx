...
const Skills = () => {
  ...
  return (
    <section id="skills">
      <div className="projects-grid container justify-evenly flex space-x-10  ">
        Skills
        ...
        {skills.map((skill, idx) => (
          <motion.a
            ...
            className="wrapper relative text-gray-800 dark:text-gray-200 hover:text-red-600 dark:hover:text-red-500 font-medium transition-colors duration-500 group flex items-center gap-2"
            href={`#${skill.name.toLowerCase()}`}
          >
           <div className="flex items-center gap-2 bg-gray-100 dark:bg-gray-800 rounded-lg px-4 py-2 transition-transform duration-300 group-hover:scale-105">
