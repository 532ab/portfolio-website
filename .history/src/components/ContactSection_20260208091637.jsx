            ...
            {showForm && (
              <>
                ...
                <motion.form
                  ...
                  className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-md bg-gray-800 p-8 rounded-2xl shadow-2xl border border-gray-700 z-50 max-h-[90vh] overflow-y-auto"
                >
                  <motion.div 
