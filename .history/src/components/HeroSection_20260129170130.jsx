...
const HeroSection = () => {
  return (
    <section className=" container h-screen bg-gradient-to-b from-gray-700 to-red-500 flex xl:flex-row flex-col-reverse items-center justify-between lg:px-24 px-10 relative overflow-hidden">
