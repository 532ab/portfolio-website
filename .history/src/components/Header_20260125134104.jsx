  ...
  return (
    <header className="absolute w-full z-50 transition-all duration-300">
        ...
        <nav className = "lg:flex hidden space-x-8">
            ...
            <div className = "md:flex hidden items-center space-x-4">
                    ...
                    transition = {{delay: 1.3, duration: 0.8}}
                        className = "text-gray-700 dark:text-gray-300 hover:text-violet-600 dark:hover:text-violet-400 transition-colors" href = "#">
                    ...
                    animate= {{opacity: 1, scale: 1}}
                    transition = {{delay: 1.3, duration: 0.8}}
                        className = "text-gray-700 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400 transition-colors duration-300" href = "#">
            ...
            <div className = "md:hidden flex items-center">
                ...
                className = "text-gray-300">
                    { isOpen ? <FiX className = "h-6 wi-6" /> : <FiMenu className = "h-6 w-6" />}
                </motion.button>
        ...
        animate = {{ opacity: isOpen ? 1 : 0,
            ...
            <div className = "pt-4 border-t border-gray-200 dakr:border-gray-700">
                <div className = "flex space-x-5">
                    <a href = "#">
                        <FiGithub className = "h-4 w-5 text-gray-300" />
                    </a>
                    <a href = "#">
                        <FiLinkedin className = "h-4 w-5 text-gray-300" />
                    </a>
                    <button 
                    onClick = {() => {
                        toggleMenu()
    ...
    >
      ...
      <div className="flex items-center justify-between mb-4">
        ...
        <button onClick={closeContactForm}>
          <FiX className="w-5 h-5 text-gray-400 hover:text-gray-200" />
        </button>
      </div>
      ...
      <form className="space-y-4">
        ...
        <button className = "w-full px-4 py-2 bg-gradient-to-r from-violet-600 to-violet-400 hover:from-violet-700 hover:to-purple-700 transition-all duration-300 rounded-lg shadow-md hover:shadow-lg hover:shadow-violet-600/50">
            Send Message
        </button>
      </form>
    </div>
