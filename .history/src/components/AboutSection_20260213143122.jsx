    ...
    >
      <div className="container mx-auto px-4">
        ...
        <div className="py-12 flex flex-col lg:flex-row items-center justify-between gap-12">
          ...
          >
            <div className="relative w-64 h-64 sm:w-72 sm:h-72 md:w-80 md:h-80 rounded-2xl overflow-hidden border-4 border-purple-500 shadow-2xl hover:shadow-purple-500/50 transition-shadow duration-300">
              <img 
