...
const HeroSection = () => {
  return (
    <section className="h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900 flex xl:flex-row flex-col-reverse items-center justify-between lg:px-24 px-6 sm:px-10 relative overflow-hidden py-10 sm:py-0">
  ...
  <div className="z-40 xl:mb-0 mb-[20%] xl:w-1/2">
    <motion.h1 
      ...
      className="text-3xl sm:text-4xl md:text-5xl lg:text-5xl font-bold z-10 mb-4 sm:mb-6"
    >
    ...
    <motion.p
      ...
      className="text-lg sm:text-xl md:text-xl lg:text-2xl text-blue-100 max-w-2xl leading-relaxed"
    >
