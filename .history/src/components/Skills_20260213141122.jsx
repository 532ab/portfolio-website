...
const Skills = () => {
  const skillCategories = {
    ...
    Tools: [
      ...
      { name: "AWS", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/amazonwebservices/amazonwebservices-plain.svg" },
    ],
  };
  ...
  const itemVariants = {
    ...
    visible: {
      opacity: 1,
      y: 0,
      transition: { type: "spring", stiffness: 150, damping: 15, duration: 0.3 },
    },
  };
