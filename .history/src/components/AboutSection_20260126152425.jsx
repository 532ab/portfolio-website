        ...
        <div className="container mx-auto px-4 h-full flex flex-col items-center justify-center">
          ...
          <div>
            <h3 className = "text-sm md:text-2xl font-bold text-pruple-200 z-50 lg:max-w-[45rem] max-w-[27rem] tracking-wider md:mt-20 sm:mt -[-40rem] mt-[-32rem]">
              I’m a Computer Science student at Indiana University with experience in full-stack development (React, Node.js, MongoDB), systems programming in C, and iOS development with SwiftUI. 
