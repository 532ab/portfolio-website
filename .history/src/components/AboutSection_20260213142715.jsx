  ...
  return (
    ...
    >
      <div className="container mx-auto px-4 py-20 flex flex-col lg:flex-row items-center justify-between gap-12">
        ...
        >
          <div className="relative w-64 h-64 sm:w-72 sm:h-72 md:w-80 md:h-80 rounded-2xl overflow-hidden border-4 border-purple-500 shadow-2xl">
            <img 
              src="/images/iu_profile.jpg" 
              alt="IU Profile" 
