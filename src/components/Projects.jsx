...
const Projects = () => {
  ...
  return (
    <section
      ref={sectionRef}
      id="projects"
      className="relative py-12 md:py-20 overflow-hidden bg-gradient-to-br from-slate-900 via-cyan-900 to-slate-900"
    >
      <div className="container mx-auto px-4 mb-12 md:mb-16 relative z-10">
        <h2
          ref={titleRef}
          className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-cyan-200 text-center mb-4"
        >
          My Projects
        </h2>
        <div
          ref={titleLineRef}
          className="w-0 h-1 bg-gradient-to-r from-cyan-400 to-blue-500 mx-auto opacity-0"
        />
      </div>
