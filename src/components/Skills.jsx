...
const Skills = () => {
  ...
  const skillCategories = {
    ...
    Cloud: [
      { name: "AWS", icon: "https://images.icon-icons.com/2407/PNG/512/aws_icon_146237.png" },
    ...
    "Developer Tools": [
      ...
      { name: "UNIX Shell", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/bash/bash-original.svg" },
      { name: "GitHub Copilot", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/github/github-original.svg" },
      { name: "Claude AI", icon: "https://cyclr.com/nitropack_static/VuXxlbQNhqQgnktlfMtCedOWhlGohlKT/assets/images/optimized/rev-0d98353/cyclr.com/wp-content/uploads/2025/05/Claude-ai-logo.png" },
    ],
    Concepts: [
      { name: "REST APIs", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/nodejs/nodejs-original.svg" },
      { name: "Authentication", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/javascript/javascript-original.svg" },
      { name: "Data Structures", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/python/python-original.svg" },
      { name: "Algorithms", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/java/java-original.svg" },
      { name: "Memory Management", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/c/c-original.svg" },
      { name: "File I/O", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/linux/linux-original.svg" },
      { name: "Agile Methodology", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/git/git-original.svg" },
    ],
    Certifications: [
  ...
  const SkillCard = ({ skill }) => (
    ...
    >
      ...
      >
        <motion.div 
          className="flex items-center justify-center w-14 h-14 sm:w-16 sm:h-16 bg-gradient-to-br from-gray-100 to-gray-200 dark:from-gray-800 dark:to-gray-700 rounded-lg shadow-md transition-all duration-300 group-hover:shadow-xl group-hover:from-violet-100 group-hover:to-violet-200 dark:group-hover:from-violet-900 dark:group-hover:to-violet-800"
        ...
        <motion.p 
          className="text-xs sm:text-sm font-semibold text-gray-700 dark:text-gray-300 group-hover:text-violet-600 dark:group-hover:text-violet-400 transition-colors duration-300 text-center px-1"
          animate={selectedSkill === skill.name ? { 
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="space-y-12">
          {Object.entries(skillCategories).map(([category, skills], idx) => (
            ...
            >
              {/* Category Title */}
              <h3 className="text-lg sm:text-2xl font-bold text-gray-800 dark:text-gray-200 flex items-center gap-3">
